...
# X = 0.4
x_p4 = 0.4
fa0_by_ra_p4 = data_interp(x_p4)
v_p4 = x_p4 * fa0_by_ra_p4

# X = 0.8
x_p8 = 0.8
fa0_by_ra_p8 = data_interp(x_p8)
...
* For $X$ = `{python} x_p4`; 
  $\frac{F_{A0}}{(-r_A)_{exit}}$ = `{python} Markdown(r"""{f:.2f} $m^3$""".format(f=fa0_by_ra_p4))`

  $V$ = `{python} v_p4` $m^3$ 

* For $X$ = `{python} x_p8`; 
  $\frac{F_{A0}}{(-r_A)_{exit}}$ = `{python} Markdown(r"""{f:.2f} $m^3$""".format(f=fa0_by_ra_p8))`
...
* For $X$ = `{python} x_p4`; 
  ...
  $V$ = `{python} Markdown(r"""{v:.2f} $m^3$""".format(v=v_p4))`

* For $X$ = `{python} x_p8`; 
  $\frac{F_{A0}}{(-r_A)_{exit}}$ = `{python} Markdown(r"""{f:.2f} $m^3$""".format(f=fa0_by_ra_p8))`

  $V$ = `{python} Markdown(r"""{v:.2f} $m^3$""".format(v=v_p8))`
...
![](../../../assets/images/reactors_in_series_schematic.png){.fragment width=90%}
...
x_3 = 0.65
v_cstr_2 = (x_3 - x_1) * data4_interp(x_3)

ax.scatter(data4['x'], Fa0_by_ra, marker='s', color='red')
ax.plot(x, y, color='black')

# CSTR 1 X = 0.2
rectangle = plt.Rectangle((0, 0), x_1, data4_interp(x_1), color='skyblue', alpha=0.4)
ax.add_patch(rectangle)
...
# CSTR 2 X = 0.65
rectangle = plt.Rectangle((x_2, 0), x_3 - x_2, data4_interp(x_3), color='forestgreen', alpha=0.4)
ax.add_patch(rectangle)

text_str = r"""$V_{{X={x:.2f}}}$ = {v:.2f} $m^3$""".format(x=x_3,v=v_cstr_2)
ax.text(0.55, 2.25, text_str, ha='center', va='bottom')
