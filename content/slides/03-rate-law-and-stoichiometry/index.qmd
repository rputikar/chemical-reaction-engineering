...
* Let $\Theta_i= N_{i_0}/N_{A_0} =  C_{i_0}/C_{A_0}$.
...
* $$C_A = C_{A_0}(1-X)$$ 
* $$C_B = C_{A_0}(\Theta_B-(b/a)X)$$ 
* $$C_C = C_{A_0}(\Theta_C+(c/a)X)$$ 
* $$C_D = C_{A_0}(\Theta_D+(d/a)X)$$ 
...
* $$ -r_A = k C_A C_B $$ 
* [$$ -r_A = k  C_{A_0}^2 (1-X) (\phi_B-(b/a)X)$$]{.magenta}
...
| :-------- | :----------------- | :--------------- | :---------------------------------------- |
| A         | $F_{A_0}$          | $-F_{A_0}X$      | $F_A = F_{A_0} - F_{A_0}X$                |
| B         | $F_{B_0}$          | $-(b/a)F_{A_0}X$ | $F_B = F_{B_0} -(b/a)N_{F_0}X$            |
| C         | $F_{C_0}$          | $(c/a)F_{A_0}X$  | $F_C = F_{C_0} +(c/a)N_{F_0}X$            |
| D         | $F_{D_0}$          | $(d/a)F_{A_0}X$  | $F_D = F_{D_0} +(d/a)N_{F_0}X$            |
| I         | $F_{I_0}$          | 0                | $F_I = F_{I_0}$                           |
| **Total** | $\mathbf{F_{T_0}}$ |                  | $\mathbf{F_T = F_{T_0} + \delta F_{A_0}X}$ |


* $\delta = +\frac{d}{a}+\frac{c}{a}-\frac{b}{a}-1$ 
  
* $\Theta_{i0}= F_{i_0}/F_{A_0} =  C_{i_0}/C_{A_0}$.
...
* We can now express $C_j (=F_j/\upsilon)$ in terms of $F, P, and \ T$
  ...
  $$
  C_j = C_{T_0} \left( \frac{F_j}{F_T} \right)
                \left( \frac{P_0}{P} \right) 
                \left( \frac{T}{T_0} \right)
  $$
