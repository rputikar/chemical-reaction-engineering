...
$C_{A0}$ = 0.2 $mol/dm^3$. Find $X_e$ for a batch reactor.
...
Consider the following elementary reaction with $K_C$ = 20 $dm^3/mol$ and
$C_{A0}$ = 0.2 $mol/dm^3$. Find $X_e$ for a flow reactor.
...
(e) What is the initial rate of reaction (X = 0) at $188 \ ^{\circ}C$, at $25
\ ^{\circ}C$, and at $288 \ ^{\circ}C$?

(f) What is the rate of reaction when X = 0.90 at $188 \ ^{\circ}C$, at $25 \
^{\circ}C$, and at $288 \ ^{\circ}C$?
