...
* Rate of adsorption = rate of attachment - rate of detachment
  ...
  - Additionally, the reaction rate is dependent on the availability of vacant
    active sites on the catalyst surface. An active site is defined as a location
    on the surface where a strong bond can form with an adsorbed species,
...
* At equilibrium $r_{AD} = 0$

  $$ k_A P_{\ce{CO}} C_v^2 = k_{-A} C_{\ce{C*S}} C_{\ce{O*S}} $$

* For $C_{\ce{C*S}} = C_{\ce{C*S}}$

  $$ (K_A P_{\ce{CO}})^{1/2} C_v =  C_{\ce{O*S}} $$
...
* If we assume the rate of depletion of the poison from the reactant gas stream
...
* Because every molecule that is adsorbed from the gas phase onto a site is
  assumed to poison the site, this rate is also equal to the rate of removal of
...
* Dividing through by $C_{t0}$ and letting $f$ be the fraction of the total
  number of sites that have been poisoned yields

  $$ \frac{df}{dt} = k_d (1 - f) C_P $$

* The fraction of sites available for adsorption $(1 - f)$ is essentially the
  activity $a(t)$
...
Exponential    1           $-da/dt = \beta_1 a$         $a = e^{-\beta_1 t}$     Ethylene hydrogenation
                                                                                 ...
                                                                                 CO; Paraffin
                                                                                 dehydrogenation on
                                                                                 Cr~2~/Al~2~O~3~; Cracking
                                                                                 of gas oil; Vinyl
                                                                                 chloride monomer
                                                                                 formation

Hyperbolic     2           $-da/dt = \beta_2 a^2$       $1/a = 1 + \beta_2 t$    Vinyl chloride monomer
                                                                                 formation; Cyclohexane
                                                                                 dehydrogenation on
                                                                                 Pt/Al~2~O~3~;
                                                                                 Isobutylene
                                                                                 hydrogenation on Ni
