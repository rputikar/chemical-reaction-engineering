...
plt.savefig("optimum_feed_temp_1.svg", bbox_inches="tight")
```
![](./optimum_feed_temp_1.svg)
...
plt.savefig("optimum_feed_temp_2.svg", bbox_inches="tight")
```
![](./optimum_feed_temp_2.svg)
...
plt.savefig("optimum_feed_temp_3.svg", bbox_inches="tight")
```
![](./optimum_feed_temp_3.svg)
...
plt.plot(v1,x1, label=f"T = {T01:.0f} K", color='#65489d')
plt.plot(v1,xe1, linestyle='--', color='#65489d')

plt.plot(v2,x2, label=f"T = {T02:.0f} K", color='#388ecc')
...
# plt.title(f"T = {T03:.0f} K")
# plt.show()
plt.savefig("./optimum_temp.svg", bbox_inches='tight')
```
![](./optimum_temp.svg)
...
plt.savefig("./optimum_temp_2.svg", bbox_inches='tight')
```
![](./optimum_temp_2.svg)
