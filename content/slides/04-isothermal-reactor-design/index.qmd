...
![](../../../assets/images/reaction_engineering_algorithm.png){width=60%}
...
![](../../../assets/images/pfr_schematic.png){width=70%}
...
* Evaluating integral using sympy
  ...
  integrand = (1 + epsilon * x)**2 / (1 - x)**2
  integral_result = integrate(integrand,(x))

  pprint(integral_result)
  ```
...
![](../../../assets/images/change_in_volumetric_flowrate.png)
...
5. Evaluate
   ...
   $$
   \frac{dX}{dV} = \frac{k C_{A0}}{\upsilon_0} 
