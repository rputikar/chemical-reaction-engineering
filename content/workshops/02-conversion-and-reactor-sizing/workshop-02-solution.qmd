...
p1_expt_data = np.genfromtxt(p1_expt_file, delimiter=',', dtype=[('x', float), ('fa0_by_ra', float)], skip_header=1)
```
...
p1_interp = interpolate.CubicSpline(p1_expt_data['x'], p1_expt_data_data['fa0_by_ra'])
```
...
ax.scatter(p1_expt_data['x'], p1_expt_data['fa0_by_ra'], marker='s', color='red')
...
def CSTR_Volume_Coordinates(curve_interp, target_volume, x_start=0, x_end=1, steps=1000, *args): 
...
def PFR_Volume_Coordinates(curve_interp, target_volume, x_start=0, x_end=1, steps=1000, *args): 
