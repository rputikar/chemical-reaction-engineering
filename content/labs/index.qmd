...
- Batch reactor ([Armfield Transparent Batch Reactor
  ...
  See [pre lab module: Tubular
  Reactor](https://storage.net-fs.com/hosting/6412700/21/) for more
  information.
- Catalytic reactor ([Armfield Catalytic Reactor
  ...
  Reactor](https://storage.net-fs.com/hosting/6412700/23/) for more
  information.  
...
Pre-laboratory modules have been developed for 2 of the experiments
specifically designed to ensure you understand:
...
* [Batch Reactor](https://storage.net-fs.com/hosting/6412700/21/)

* [Catalytic Reactor](https://storage.net-fs.com/hosting/6412700/23/)


## Things to do before labs begin

* Check lab schedule: Lab schedule: 2024 S1
