...
3. Yield and selectivity of EO. \hfill (6 marks) 

    (a) Based on inlet conditions, calculate the yield and selectivity of EO. 
    (b) For the outlet composition given in @tbl-outlet-gas-comp calculate yield
        and selectivity of EO. Assume isothermal operations. Comment on the results.  
