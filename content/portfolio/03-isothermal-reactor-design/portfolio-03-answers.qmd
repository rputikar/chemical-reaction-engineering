...
combined_cycle = (cycler(color=custom_colors[:len(line_styles)]) + cycler(linestyle=line_styles))
...
plt.plot(w_p, x_p, label='conversion')
plt.plot(w_p, vv0_p, label='$\\upsilon/\\upsilon_0$')
plt.plot(w_p, p_p, label='$P/P_0$')
